pipeline {
    ...
    environment {
        GIT_REPO = 'https://github.com/abhishekpu98/Project1.git'
        AWS_REGION = 'ap-south-1'
        ECR_REPO_NAME = 'ecr-repo1'
        ECR_PUBLIC_REPO_URI = '567251175749.dkr.ecr.ap-south-1.amazonaws.com/ecr-repo1'
        IMAGE_TAG = 'latest'
        AWS_ACCOUNT_ID = '567251175749'
